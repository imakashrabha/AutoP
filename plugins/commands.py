...
async def approve_new(client, m):
    ...
    try:
        ...
        try:
            await client.send_message(m.from_user.id, """𝖧𝗂𝗂 {}, 𝖸𝗈𝗎𝗋 𝗋𝖾𝗊𝗎𝖾𝗌𝗍 {} 𝗁𝖺𝗌 𝖻𝖾𝖾𝗇 𝖺𝖼𝖼𝖾𝗉𝗍𝖾𝖽. \n\n𝖩𝗈𝗂𝗇 𝗈𝗎𝗋 𝖼𝗁𝖺𝗇𝗇𝖾𝗅 𝖿𝗈𝗋 𝗇𝖾𝗐 𝗋𝖾𝗅𝖾𝗌𝖾𝖽, 𝖾𝗑𝖼𝗅𝗎𝗌𝗂𝗏𝖾 𝗆𝗈𝗏𝗂𝖾𝗌, 𝖺𝖽𝗎𝗅𝗍 𝗅𝖾𝖺𝗄𝗌 𝖼𝗈𝗅𝗅𝖾𝖼𝗍𝗂𝗈𝗇𝗌.\n\n• 𝖬𝗈𝗏𝗂𝖾 𝖢𝗁𝖺𝗇𝗇𝖾𝗅 \n https://t.me/+pzy_4_fBWvZhMTJl\n\n• 𝖠𝖽𝗎𝗅𝗍 𝖢𝗁𝖺𝗇𝗇𝖾𝗅 \n https://t.me/+sFM7gOAbHxhhODg1 \n\n • 𝖳𝗁𝖾 𝖲𝖾𝗅𝗅𝗂𝗇𝗀 𝖹𝗈𝗇𝖾\n https://t.me/+VBHKmjS9YrY5NGFl \n\n 𝖢𝗅𝗂𝖼𝗄 𝗁𝖾𝗋𝖾 𝗍𝗈 𝗃𝗈𝗂𝗇 𝖼𝗁𝖺𝗇𝗇𝖾𝗅𝗌 𝖩𝗈𝗂𝗇 𝖭𝗈𝗐.""".format(m.from_user.mention, m.chat.title))
        except:
            pass
    except Exception as e:
        print(str(e))
